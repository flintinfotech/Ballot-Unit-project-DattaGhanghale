...
const NoticeBanner: React.FC = () => {
  return (
    ...
    >
      मतदानाच्या दिवशी सुद्धा "शिट्टी" चिन्हा समोरील निळे बटन दाबावे.
    </div>
  );
};
...
const ShareButton: React.FC = () => {
  const handleShare = (): void => {
    const message =
      ...
      "https://laturkharolag-28.flintinfotechlive.site";
...
const BannerWithButton: React.FC = () => {
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        <p>
          <strong>सूचना:</strong> खालील उमेदवाराला मतदान करावे, अन्यथा आपले मत अवैध ठरेल.
        </p>
        <hr />
        <p>
